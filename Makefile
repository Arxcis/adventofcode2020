...
#
2021:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/test.sh && exit"
2021.day-01:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-01/test.sh && exit"
2021.day-02:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-02/test.sh && exit"
2021.day-03:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-03/test.sh && exit"
2021.day-04:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-04/test.sh && exit"
2021.day-05:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-05/test.sh && exit"
2021.day-06:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-06/test.sh && exit"
2021.day-07:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-07/test.sh && exit"
2021.day-08:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-08/test.sh && exit"
2021.day-09:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-09/test.sh && exit"
2021.day-10:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-10/test.sh && exit"
2021.day-11:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-11/test.sh && exit"
2021.day-12:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-12/test.sh && exit"
2021.day-13:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-13/test.sh && exit"
2021.day-14:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-14/test.sh && exit"
2021.day-15:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-15/test.sh && exit"
2021.day-16:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-16/test.sh && exit"
2021.day-17:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-17/test.sh && exit"
2021.day-18:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-18/test.sh && exit"
2021.day-19:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-19/test.sh && exit"
2021.day-20:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-20/test.sh && exit"
2021.day-21:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-21/test.sh && exit"
2021.day-22:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-22/test.sh && exit"
2021.day-23:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-23/test.sh && exit"
2021.day-24:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-24/test.sh && exit"
2021.day-25:
	docker run -ti -v $(shell pwd):/aoc $(DOCKER_TAG) /bin/bash -c "cd /aoc && ./2021/day-25/test.sh && exit"
